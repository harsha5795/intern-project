...
public class EmailUtil {
    ...
    public void SendSimpleMessage(String to , String subject , String text , List<String> list){
        ...
        message.setFrom("mchandraharsha04@gmail.com");
        message.setTo(to);
...
// setTo: This method is used to specify the primary recipient(s) of the email.
// setCc: This method is used to specify recipients who should receive a copy (CC) of the email.
    ...
    public void  forgetMail(String to , String subject, String password) throws MessagingException {
        ...
        helper.setFrom("mchandraharsha04@gmail.com");
        helper.setTo(to);
